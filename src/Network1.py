...
class Network(object):
    ...
    class __Network:
        def __init__(self):
            ...
            self.connectTread = threading.Thread(target=self.__connect, args=('10.0.0.204', 4040), daemon=True)
        ...
        # def getConnectionQueue(self) -> Queue:
        #     return self.__connection_queue
